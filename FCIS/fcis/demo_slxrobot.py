...
update_config(cur_path + '/../experiments/slxrobot/cfgs/fcis_slxrobot_demo.yaml')
...
def main():
    ...
    # load demo data
    # image_names = glob.glob('%s/../demo/[0-9]*.jpg'%cur_path)
    image_names = glob.glob('%s/../demo/*.png' % cur_path)
    data = []
    ...
    arg_params, aux_params = load_param(cur_path + '/../model/fcis_coco', 8, process=True)
    # arg_params, aux_params = load_param(cur_path + '/../model/slxrobot_floor', 12, process=True)
    # resnet_arg_params, resnet_aux_params = load_param(cur_path + '/../model/pretrained_model/resnet_v1_101', 0, process=True)

    # for name, array in arg_params.items():
    #     if name in resnet_arg_params:
    #         continue
    #     else:
    #         print(name, '   ', array)
